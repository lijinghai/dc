  ...
  "node_modules/.pnpm/p-limit@3.1.0/node_modules/p-limit/index.js"(exports, module) {
    ...
    var pLimit = (concurrency) => {
      ...
      const enqueue = (fn, resolve2, ...args) => {
        queue.enqueue(run2.bind(null, fn, resolve2, ...args));
        (async () => {
...
var import_find_up2 = __toModule(require_find_up());
...
var import_supports_hyperlinks = __toModule(require_supports_hyperlinks());
...
exports.__toModule = __toModule; exports.remove = remove; exports.exclude = exclude; exports.cmdExists = cmdExists; exports.getVoltaPrefix = getVoltaPrefix; exports.getCommand = getCommand; exports.parseNi = parseNi; exports.parseNr = parseNr; exports.parseNu = parseNu; exports.parseNrm = parseNrm; exports.parseNx = parseNx; exports.require_prompts = require_prompts3; exports.getConfig = getConfig; exports.getDefaultAgent = getDefaultAgent; exports.getGlobalAgent = getGlobalAgent; exports.detect = detect; exports.runCli = runCli; exports.run = run;
